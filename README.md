...
1. 访问 Release 页面：https://github.com/ccx121014/ConnectHub/releases
2. 下载 `ConnectHub-Client.zip` 和 `ConnectHub-Server.zip`
3. 解压到任意目录
4. **双击** `ConnectHub-Client.exe` 启动客户端
5. **双击** `ConnectHub-Server.exe` 启动服务器
